...
console.log(`incremento(5, 1) = ${incremento(5,1)}`);  // 6
console.log(`incremento(5) = ${incremento(5)}`);     // 6

// parâmetros são opcionais
function constroiNome(primeiroNome: string, ultimoNome?: string) {
    if (ultimoNome)
...
console.log(constroiNome("Bob"));                          // Bob
console.log(constroiNome("Bob", "Adams", "Sr."));  // Bob Adams
console.log(constroiNome("Bob", "Adams"));         // Bob Adams